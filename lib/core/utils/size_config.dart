...
//A custom class for handling text size,
//margin szie and other responsiveness related issues
class SizeConfig {
  // static keyword included so you can call this method
  //without instantiating an object of it like so :
